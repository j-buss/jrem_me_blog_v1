...
$$
\hat{y}_i(x_{(j)}) = b_0 + b_1 x_{i1} + \dots + b_{j-1}x_{i,j-1} + b{j+1}x_{i,j+1} + \dots + b_{k}x_{i1}
$$
...
* If $x_j$ is a candidate variable, a horizontal band indicates there is no additional useful information in $x_j$ for predictin $y$