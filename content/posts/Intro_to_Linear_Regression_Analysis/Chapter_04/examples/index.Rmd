...
```{r}
library(MASS)
SoftDrink.lm.RStudentRessiduals <- studres(SoftDrink.lm)
head(SoftDrink.lm.RStudentRessiduals,5)
```
...
SoftDrink.Residual_df <- data.frame(
    ...
    SoftDrink.lm.RStudentRessiduals
)
...
qqnorm(SoftDrink.lm.RStudentRessiduals,
       ylab="R Student Residuals",
       xlab="Normal Scores",
       main="Delivery Time"
       , datax=TRUE
)
qqline(SoftDrink.lm.RStudentRessiduals, distribution=qnorm, datax=TRUE)
```
