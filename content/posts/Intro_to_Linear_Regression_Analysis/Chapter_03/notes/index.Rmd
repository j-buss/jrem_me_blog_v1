...
```
* _Note that this table is nearly the same as for an SLR. The difference being the degrees of freedom. variable k which depicts the # of coefficients for the regressors. For SLR this is 1 so the degrees of freedom are 1, n-2, n-1 respectively, but for MLR we see it is updated to k, n-k-1, n-1; which upon further inspection is exaclty the same as SLR with a k=1._
