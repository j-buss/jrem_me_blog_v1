...
- Row of matrix $\mathbf{X}$: $x_i = \begin{pmatrix} x_{i1}\\x_{i2}\\\vdots\\x_{ip} \end{pmatrix}$; *Note: even though it is a __row__ vector the default orientation is as a column
- Column of matrix $\mathbf{X}$: $\mathbf{x}_j = \begin{pmatrix} x_{1j}\\x_{2j}\\\vdots\\x_{nj} \end{pmatrix}$
